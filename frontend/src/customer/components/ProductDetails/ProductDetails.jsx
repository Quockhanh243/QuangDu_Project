                ...
                <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
                    ...
                    lg:pb-24">
                        <div className="lg:col-span-2 ">
                            <h1 className="text-lg lg:text-x1 font-semibold text-gray-900">Univer </h1>
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className="mt-6">
                                ...
                                hover:text-indigo-400'>387 Reviews</p>
                                </div>
                            </div>
                            ...
                            <Grid item xs={5}>
                                ...
                                <Box className="mt-5 space-y-3">
                                    ...
                                    <Grid container alignItems="center" gap={2}>
                                        ...
                                        <Grid item xs={7}>
                                            <LinearProgress sx={{ bgcolor: "#d0d0d0", borderRadius: 4, height: 7 }} variant='determinate' value={50} color='secondary' />
                                        </Grid>
                                    </Grid>
